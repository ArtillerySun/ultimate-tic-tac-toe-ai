...
class StudentAgent:
    ...
    def __init__(self):
        ...
        self.model.load_state_dict(torch.load('model/uttt_model_new.pth', map_location=torch.device('cpu'), weights_only=True))
        self.model.eval()
